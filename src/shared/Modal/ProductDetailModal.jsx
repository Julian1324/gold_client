    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Body>
                    <div className='d-flex bodyResponsive'>
                        <img src={image} alt="" className='rounded imgResponsive' />
                        <div className='d-flex flex-column ms-5 contentResponsive' style={{ width: '100%' }}>
