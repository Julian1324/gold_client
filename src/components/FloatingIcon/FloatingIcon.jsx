...
const FloatingIcon = ({optionalMargin = 0}) => {
    ...
    const floatingStyle = {
        ...
        alignItems: "center",
        marginBottom: optionalMargin + "vh",
        zIndex: 1000,
    };
